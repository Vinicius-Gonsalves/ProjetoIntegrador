    ...
    <body>     
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-md-offset-1">
                            <div class="dropdown">
                                ...
                                <li>
                                    <a onclick="window.location.href='cadastro.php'" data-dismiss="modal"><span class="glyphicon glyphicon-user"></span> Cadastrar Marcas</a>
                                </li>
                              </ul>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <table id="table" class="table table-striped table-bordered" cellspacing="0" width="100%">
								...
								<?php 
									$busca = mysql_query("select * from marca");
        ...
        <div class="container-fluid">
            <div class="panel-footer">
                <strong>Projeto Integrador - Airton Fouchy <i class="glyphicon glyphicon-copyright-mark"></i></strong>
            </div>            
        </div>
    </body>
</html>