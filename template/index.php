                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-md-offset-1">
                            <div class="dropdown">
                                ...
                                <li>
                                    <a onclick="window.location.href='cadastro.php'" data-dismiss="modal"><span class="glyphicon glyphicon-user"></span> Cadastrar Veiculos</a>
                                </li>
                              </ul>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <table id="table" class="table table-striped table-bordered" cellspacing="0" width="100%">
								...
								<?php 
									$busca = mysql_query("select * from veiculos");
            ...
            $(document).ready(function() {
                ...
                $('.moreInfo').click( function () {
                    ...
                    BootstrapDialog.show({
                        ...
                        +"</p>"
                        +"<p>"
                            +"<strong>Marca</strong>: "+ row[1]
                        +"</p>"
                        +"<p>"
                            +"<strong>modelo</strong>: "+ row[2]
                        +"</p>"
                        +'<p>'
                            +'<strong>Quilometragem</strong>: '+ row[3]
                        +'</p>'
                        +'<p>'
                            +'<strong>Preço</strong>: '+ row[4]
                        +'</p>'
                   });
                });
            } );
