...
$buscaPai       = mysql_query("select * from pessoas where ID= $codigoPai"); //executa no banco de dados.
    ...
    <body>     
        <div class="container-fluid">
			...
			<div class="row header-page">
                <div class="col-md-12">
                    <h1 align="center"><img src="../../images/nutren-a.png"> Avaliação de <?php echo $PacienteNome ;?></h1>
                </div>                
            </div>
            <hr>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <table id="table" class="table table-striped table-bordered" cellspacing="0" width="100%">
								...
								<?php 
									$busca = mysql_query("select * from pessoas_avaliacao where PessoaID= $codigoPai");
									...
									?>
                                        <tr>
                                            ...
                                            <td><?php echo transfData($row['UsuarioIncDataHora']);?></td>                                        
											<td align="center">
