    ...
    <body>     
        <div class="container-fluid">
			...
			<div class="row header-page">
                <div class="col-md-12">
                    <h1 align="center"><img src="../../images/nutren-a.png">Lista de Alimentos</h1>
                </div>                
            </div>
            <hr>
            ...
            <div class="panel panel-default">
                ...
                <div class="col-md-12" align="right">
                    <a href="cadastro.php"><input class="btn btn-default btn-md" type="button" value="Cadastrar"/></a>
                </div>
            </div>  
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <table id="table" class="table table-striped table-bordered" cellspacing="0" width="100%">
								...
								<?php 
                                    $busca = mysql_query("select B.Nome as 'Grupo', A.ID, A.Nome, A.Porcao, A.Calorias from alimentos A left join alimentos_grupo B on (A.GrupoID=B.ID) order by A.Nome");
                                    ...
                                    ?>
                                        <tr>
											...
											<td align="center">
                                                ...
                                                <button onclick="window.location.href='../alimentos_medidas/index.php?codigo=<?php echo $codigo;?>'" type="button" class="btn btn-default btn-xs" data-dismiss="modal"><span class="glyphicon glyphicon-apple"></span> </button>                                         
            ...
            $(document).ready(function() {
                ...
                /*$('.moreInfo').click( function () {
                    ...
                    BootstrapDialog.show({
                        ...
                        +"</p>"
                        +"<p>"
                            +"<strong>Porcao</strong>: "+ row[2]
                        +"</p>"
                        +"<p>"
                            +"<strong>Calorias</strong>: "+ row[3]
                        +"</p>"
                        +"<p>"
                            +"<strong>Grupo</strong>: "+ row[4]
                        +"</p>"
