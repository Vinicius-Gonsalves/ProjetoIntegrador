    ...
    <body>     
        <div class="container-fluid">
            <div class="row header-page">
                <div class="col-md-12">
                    <h1 align="center">Listagem de Fabricante</h1>
                </div>                
            </div>
            <hr>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-md-offset-1">
                            <div class="dropdown">
                                ...
                                <li>
                                    <a onclick="window.location.href='cadastro.php'" data-dismiss="modal"><span class="glyphicon glyphicon-user"></span> Cadastrar Fabricante</a>
                                </li>
                              </ul>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <table id="table" class="table table-striped table-bordered" cellspacing="0" width="100%">
								...
								<?php 
									$busca = mysql_query("select * from fabricante");
